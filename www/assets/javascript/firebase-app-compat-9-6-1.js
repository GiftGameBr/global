!(function (e, t) {
  ...
  function c(e, t) {
    ...
    for (const r in t)
      t.hasOwnProperty(r) && "__proto__" !== r && (e[r] = c(e[r], t[r]));
    return e;
  }
  class n {
    constructor() {
    ...
    wrapCallback(i) {
      return (e, t) => {
        e ? this.reject(e) : this.resolve(t),
          "function" == typeof i &&
            (this.promise.catch(() => {}), 1 === i.length ? i(e) : i(e, t));
      };
    }
  }
  ...
  class m {
    ...
    initialize(e = {}) {
      ...
      var r,
        n,
        s = this.getOrInitializeService({ instanceIdentifier: i, options: t });
      for ([r, n] of this.instancesDeferred.entries())
        i === this.normalizeInstanceIdentifier(r) && n.resolve(s);
      return s;
    }
    onInit(e, t) {
  ...
  function $(t, i) {
    try {
      ...
      N.debug(
        `Component ${i.name} failed to register with FirebaseApp ${t.name}`,
        e
      );
    }
  }
  ...
  function P(e) {
    ...
    if (R.has(t))
      return (
        N.debug(`There were multiple attempts to register component ${t}.`), !1
      );
    R.set(t, e);
  ...
  class j {
    ...
    checkDestroyed() {
      if (this.isDeleted)
        throw F.create("app-deleted", { appName: this._name });
    }
  }
  const H = "9.6.1";
  function T(e, t = {}) {
    ...
    var i = Object.assign({ name: A, automaticDataCollectionEnabled: !1 }, t);
    const r = i.name;
    if ("string" != typeof r || !r)
      throw F.create("bad-app-name", { appName: String(r) });
    var n = S.get(r);
    if (n) {
      if (h(e, n.options) && h(i, n.config)) return n;
      throw F.create("duplicate-app", { appName: r });
    }
    const s = new g(r);
  ...
  function B(e, t, i) {
    ...
    P(new d(`${r}-version`, () => ({ library: r, version: t }), "VERSION"));
  }
  function V(e, t) {
            ...
            null === s
              ...
              : (e, t, ...i) => {
                  var r = i
                    ...
                    .filter((e) => e)
                    .join(" ");
                  t >= (null !== n && void 0 !== n ? n : e.logLevel) &&
                    s({
  ...
  (L = ""),
    P(new d("platform-logger", (e) => new O(e), "PRIVATE")),
    B(w, C, L),
    B(w, C, "esm2017"),
    B("fire-js", "");
  var x = Object.freeze({
    ...
    getApp: function (e = A) {
      var t = S.get(e);
      if (!t) throw F.create("no-app", { appName: e });
      return t;
    },
    getApps: function () {
  ...
  class W {
    constructor(e, t) {
      (this._delegate = e),
        (this.firebase = t),
        $(e, new d("app-compat", () => this, "PUBLIC")),
    ...
    delete() {
      return new Promise((e) => {
        ...
        () => (this.firebase.INTERNAL.removeApp(this.name), M(this._delegate))
      );
    }
    _getService(e, t = A) {
      var i;
      ...
      return (
        r.isInitialized() ||
          "EXPLICIT" !==
            (null === (i = r.getComponent()) || void 0 === i
              ? void 0
              : i.instantiationMode) ||
          r.initialize(),
  ...
  function Y(n) {
              ...
              P(i) &&
                ...
                ((e = (e = o()) => {
                  if ("function" != typeof e[t])
                    throw G.create("invalid-app-argument", { appName: r });
                  return e[t]();
                }),
                void 0 !== i.serviceProps && c(e, i.serviceProps),
                (a[t] = e),
    ...
    function o(e) {
      if (((e = e || A), !l(s, e))) throw G.create("no-app", { appName: e });
      return s[e];
    }
    return (
      (a.default = a),
  ...
  const X = K;
  B("@firebase/app-compat", "0.1.12", void 0);
  return X.registerVersion("firebase", "9.6.1", "app-compat-cdn"), X;
});
